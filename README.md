**Notice**: I (IOT-123) have forked this for fairly focussed customizations for the ASSIMILATE IOT NETWORK (D1 Mini). These customisations (callbacks, and extra config editing) may be of some use but the motivation is _not_ to provide a general purpose library.
